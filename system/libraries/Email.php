...
class CI_Email {
	...
	var	$smtp_host		= "mail.kidcaresystems.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "admin@kidcaresystems.com	";		// SMTP Username
	var	$smtp_pass		= "Oddtimz1@";		// SMTP Password
